        ...
        {isAdding && (
          <div className="p-5 border-b border-white/5 bg-white/5">
            <form onSubmit={handleAdd} className="flex items-center gap-3">
              ...
              <button
                type="submit"
                className="bg-accent text-white px-4 py-2 rounded-lg text-sm font-bold flex items-center gap-2 hover:brightness-110"
              >
              ...
              <button
                ...
                className="bg-white/10 text-ink px-4 py-2 rounded-lg text-sm font-bold flex items-center gap-2 hover:bg-white/20 border border-white/10"
              >
        ...
        <table className="w-full text-left border-collapse">
          <thead className="bg-white/5">
            <tr className="font-mono text-[0.7rem] uppercase tracking-[0.1em] text-ink-muted">
              ...
              <th className="px-6 py-4 font-normal">Acronym</th>
          ...
          <tbody>
            {displayedOffices.map((office) => (
              ...
              >
                ...
                <td className="px-6 py-5 border-b border-border group-last:border-none text-sm text-ink-muted">
                  {office.acronym || "-"}
                </td>
                <td className="px-6 py-5 border-b border-border group-last:border-none text-sm text-ink-muted">
                  {office.email || "-"}
                ...
                <td className="px-6 py-5 border-b border-border group-last:border-none text-right">
                  {editingId === office.id ? (
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <button
                        onClick={cancelEdit}
                        className="p-1.5 bg-white/10 text-ink-muted rounded hover:bg-white/20"
                      >
                        <X className="w-4 h-4" />
                      </button>
                    </div>
